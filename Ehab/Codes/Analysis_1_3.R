...
libraries("MASS","ggplot2","vcd","psych","fitdistrplus","ismev")
...
Shp=fit_w$estimate[1]
Scl=fit_w$estimate[2]
...
NewSynthNew=rpois(50000,Shp)
describe(NewSynthNew)
plot(NewData)
...
Shp=fit_ps$estimate[1]
Scl=fit_ps$estimate[2]
...
sink("../Results/Interpolation/Weibull_Fit.doc")
summary(fit_w)
sink()
